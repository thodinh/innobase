...
module.exports = class Perf {
	...
	constructor() {
		...
		this.perf = null;
		this.counters = null;
		this.scale = 1000; // milliseconds
		this.precision = 1000; // 3 digits
		this.totalKey = 'total'; // where to store the total
		this.minMax = false; // track min/avg/max per metric
